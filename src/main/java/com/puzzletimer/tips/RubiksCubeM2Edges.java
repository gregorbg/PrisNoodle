...
public class RubiksCubeM2Edges implements Tip {
    ...
    public String getTip(Scramble scramble) {
        ...
        String[] speffzScheme = analysis.getLetteringScheme(new PieceType("EDGE", 12, 2));
        List<List<StickerTarget>> foo = analysis.compileSolutionCycles(new PieceType("EDGE", 12, 2));
