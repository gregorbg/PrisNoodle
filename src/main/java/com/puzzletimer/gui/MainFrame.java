...
public class MainFrame extends JFrame {
    ...
    private class TimesScrollPane extends JScrollPane {
        ...
        private void setSolutions(final Solution[] solutions) {
            ...
            for (int i = 0; i < solutions.length; i++) {
                ...
                labelRetry.setIcon(new ImageIcon(getClass().getResource("/com/puzzletimer/retry.png")));
                ...
                labelX.setIcon(new ImageIcon(getClass().getResource("/com/puzzletimer/x.png")));
    ...
    public MainFrame(
        ...
        try {
            ...
            inspectionBeep.open(AudioSystem.getAudioInputStream(new BufferedInputStream(MainFrame.class.getResourceAsStream("/com/puzzletimer/inspection/beep.wav"))));
        ...
        this.menuItemSmoothTiming.addActionListener(e -> MainFrame.this.timerManager.setSmoothTimingEnabled(MainFrame.this.menuItemSmoothTiming.isSelected()));
    ...
    private void createComponents() {
        ...
        Image icon = Toolkit.getDefaultToolkit().getImage(getClass().getResource("/com/puzzletimer/icon.png"));
