...
public class ColorScheme {
    public static class FaceColor {
        ...
        public static Color fromTNoodle(org.worldcubeassociation.tnoodle.svglite.Color tNoodleColor) {
            return new Color(
                    tNoodleColor.getRed(),
        ...
        public org.worldcubeassociation.tnoodle.svglite.Color toTNoodle() {
            return new org.worldcubeassociation.tnoodle.svglite.Color(
                    this.color.getRed(),
                    this.color.getGreen(),
                    this.color.getBlue(),
                    this.color.getAlpha()
    ...
    public HashMap<String, org.worldcubeassociation.tnoodle.svglite.Color> toTNoodle() {
        HashMap<String, org.worldcubeassociation.tnoodle.svglite.Color> tNoodleScheme = new HashMap<>();
